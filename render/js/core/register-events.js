...
export const InputEvent = {
    ...
    MouseWheel: 2,
    Touch: 3,
    Gamepad: 5, //skip 4 since that was used in Legacy for Button Click
    VR: 6,
    Crypto: 7
};
...
export function registerKeyboardEvents(connection, videoPlayer) {
...
export function registerMouseEvents(connection, videoPlayer, playerElement) {
    const _connection = connection;
    const _videoPlayer = videoPlayer;
    ...
    function sendTouch(e, phase) {
        ...
        for (let i = 0; i < touches.length; i++) {
            ...
            phrases[i] =
                changedTouches.find(function (e) {
        ...
        for (let i = 0; i < touches.length; i++) {
            ...
            const y =
                _videoPlayer.videoHeight - (touches[i].pageY - originY) / scale;
        ...
        _connection && _connection.sendMsg(data.buffer);
    }
